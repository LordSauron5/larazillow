        ...
        <div class="mb-8 mt-4 flex flex-wrap gap-2">
            ...
            <div class="flex flex-nowrap items-center">
                <select 
                    ...
                    name="" id="" class="input-filter-l w-28"
                >
                ...
                <select 
                    ...
                    name="" id="" class="input-filter-r w-28"
                >
            ...
            <div class="flex flex-nowrap items-center">
                <input 
                    ...
                    type="text" placeholder="Area From" class="input-filter-l w-28"
                />
                <input 
                    v-model.number="filterForm.areaTo"
                    type="text" placeholder="Area To" class="input-filter-r w-28"
                />
            </div>
